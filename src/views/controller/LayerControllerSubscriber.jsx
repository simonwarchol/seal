...
import RasterChannelController from "./RasterChannelController.jsx";
import LayerController from "./LayerController.jsx";
import ImageAddButton from "./ImageAddButton.jsx";
import BitmaskChannelController from "./BitmaskChannelController.jsx";
...
export function LayerControllerSubscriber(props) {
  ...
  const [componentWidth, componentHeight] =
  ...
  const layerIs3DIndex =
    rasterLayers?.findIndex && rasterLayers.findIndex((layer) => layer.use3d);
  return (
